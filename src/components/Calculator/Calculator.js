...
render() {
  return (
    ...
    <div className="calculator">
     ...
     <div className="row">
      <button className="button" onClick={this.handleChange('value')} value="7">7</button>
      <button className="button" onClick={this.handleChange('value')} value="8">8</button>
      <button className="button" onClick={this.handleChange('value')} value="9">9</button>
      <button className="symbol-button" onClick={this.handleSymbolChange('symbol')} value="/">/</button>
     </div>
     <div className="row">
      <button className="button" onClick={this.handleChange('value')} value="4">4</button>
      <button className="button" onClick={this.handleChange('value')} value="5">5</button>
      <button className="button" onClick={this.handleChange('value')} value="6">6</button>
      <button className="symbol-button" onClick={this.handleSymbolChange('symbol')} value="*">*</button>
     </div>
     <div className="row">
      <button className="button" onClick={this.handleChange('value')} value="1">1</button>
      <button className="button" onClick={this.handleChange('value')} value="2">2</button>
      <button className="button" onClick={this.handleChange('value')} value="3">3</button>
      <button className="symbol-button" onClick={this.handleSymbolChange('symbol')} value="+">+</button>
     </div>
     <div className="row">
      <button className="button" onClick={this.handleDecimalChange('value')} value=".">.</button>
      <button className="button" onClick={this.handleZeroChange('value')} value="0">0</button>
      <button className="button" onClick={this.submitEquation}>=</button>
      <button className="symbol-button" onClick={this.handleSymbolChange('symbol')} value="-">-</button>
     </div>
     <div className="row">
      <button className="symbol-button" onClick={this.empty}>Clear</button>
     </div>
   </div>
  <div>
